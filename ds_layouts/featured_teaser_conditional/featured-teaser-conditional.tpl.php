...
/**
 * @file
 * Display Suite Featured Teaser Conditional template.
 *
 * Available variables:
 *
 * Layout:
...
<article <?php print $layout_attributes; ?> class="<?php print $classes;?> featured">
  ...
  <?php endif; ?>
    ...
    <div class="inner-content<?php print $content_area_classes; ?>">
